...
const RecipesPopularView = () => {
  ...
  return (
    <>
      <div className="px-10 py-10 mx-auto drop-shadow-lg pb-20">
        <div className="grid lg:grid-cols-2 gap-4">
          {loadingStateRecipe === "pending" &&
            Array(4)
              .fill({})
              .map((ingredient, idx) => {
                return (
        ...
        {loadingStateRecipe === "succeeded" && filteredRecipes.length === 0 && (
            ...
            filteredRecipes.map((recipe) => {
              return (
                ...
                >
                  ...
                  <div className="max-w-full sm:max-w-full md:max-w-full w-full lg:max-w-full lg:flex bg-white  rounded-md hover:bg-red-200  
                  lg:min-h-full
                  ">
                    <div
...
export default RecipesPopularView;